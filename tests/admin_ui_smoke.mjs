...
assert(adminHtml.includes('/static/css/admin.css?v=20260921-3'));
assert(adminHtml.includes('/static/js/admin.js?v=20260921-2'));
...
assert(adminJs.includes('/data/media/${escapeHtml(item.media_path)}'));
