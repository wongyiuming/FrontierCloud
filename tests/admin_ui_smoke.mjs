...
assert(adminHtml.includes('/static/js/admin.js?v=20260910-3'));
...
assert.match(adminCss, /\.tree\s*\{[^}]*height:\s*0;/s);
assert.match(adminCss, /\.tree\s*\{[^}]*overflow-y:\s*scroll;/s);
assert.match(adminCss, /\.key-panel\.expanded\s*\{[^}]*flex:\s*0 0 58px;/s);
