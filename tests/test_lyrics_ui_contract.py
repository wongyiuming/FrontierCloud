...
class LyricsUiContractTests(unittest.TestCase):
    ...
    def test_default_lyric_is_versioned_and_startup_backfilled(self):
        default_lrc = (ROOT / "data/media/lyrics/default.lrc").read_text(encoding="utf-8")
        ...
        self.assertEqual(default_lrc, "[00:00.00]建设中，暂无歌词\n")
