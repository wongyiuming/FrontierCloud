...
class PlayerUIContractTests(unittest.TestCase):
    ...
    def test_audio_player_offers_four_line_lrc_and_three_column_fullscreen_lyrics(self):
        ...
        self.assertIn('id="lyricPrevious"', audio_template)
        self.assertIn('id="lyricCurrent"', audio_template)
        self.assertIn('id="lyricNext1"', audio_template)
        self.assertIn('id="lyricNext2"', audio_template)
        ...
        self.assertIn("grid-template-rows: repeat(4, minmax(0, 1fr))", player_style)
